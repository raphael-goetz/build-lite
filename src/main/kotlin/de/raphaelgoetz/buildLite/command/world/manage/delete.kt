...
fun getDeleteArgument(server: BuildServer): LiteralArgumentBuilder<CommandSourceStack?>? {
    return Commands.literal("delete")
        .then(Commands.argument("world", StringArgumentType.word())
            ...
            .executes { ctx ->
                ...
                if (!world.isWorld() || buildWorld == null) {
                    player.sendTransText("command.world.manage.delete.no-world") {
